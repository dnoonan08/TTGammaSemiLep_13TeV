...
void initCrossSections(){
    ...
    crossSections["TTGamma_Dilepton"]    =  {1.495*1.4852, 1.495*1.4852, 1.495*1.4852}; //2.4243;
    crossSections["TTGamma_SingleLept"]  =  {5.056*1.4852, 5.056*1.4852, 5.056*1.4852}; //10.234;
    crossSections["TTGamma_Hadronic"]    =  {4.149*1.4852, 4.149*1.4852, 4.149*1.4852}; //10.528;

    crossSections["TTGamma_Dilepton_Pt100"]    =  {0.03412*1.4852, 0.03412*1.4852, 0.03412*1.4852};
    ...
    crossSections["TTGamma_Hadronic_small"]    =  {4.164*1.4852, 4.164*1.4852, 4.164*1.4852}; //10.528;
    crossSections["TTGamma_SingleLept_small"]  =  {5.076*1.4852, 5.076*1.4852, 5.076*1.4852}; //10.234;
    crossSections["TTGamma_Dilepton_small"]    =  {1.496*1.4852, 1.496*1.4852, 1.496*1.4852}; //2.4243;

    crossSections["TTGamma_noFullyHad"]    =  {5.076*1.4852 + 1.496*1.4852, 5.076*1.4852 + 1.496*1.4852, 5.076*1.4852 + 1.496*1.4852} ;
