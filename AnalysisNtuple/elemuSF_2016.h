...
double pho2016IDSF[10][5][3]={ { {0.934969,0.939227,0.943484}, {0.942478,0.955224,0.967970}, {0.947209,0.961306,0.975403}, {0.953944,0.972455,0.990966}, {0.953604,0.972455,0.991306}, },
...
double get2016PhoSF(double pt, double eta, int systLevel){
//double getPhoSF(double pt, double eta, int systLevel){
	...
	double phoSF = pho2016IDSF[phoIDEtaRegion][phoIDPtRegion][systLevel];
