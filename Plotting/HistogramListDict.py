   ...
   #                   "presel_METPhi"                         : ["pfMETPhi"  , "presel_METPhi"   , [100,-3.15,3.15], extraCuts      , "", True],
    ...
    #		  "phosel_DiphoMass"                      : ["DiphoMass"     , "phosel_DiphoMass"                     ,       [80,0,400], extraPhotonCuts%("phoMediumID"), "", True],
      ...
      #                "phosel_SecondLeadingPhotonEt"          : ["phoEt[1]"      , "phosel_SecondLeadingPhotonEt"         ,      [300,0,300], extraPhotonCuts%("phoMediumID"), "", True],
                      ...
                      "phosel_dRLeadingHadronicPhotonLepton"          : ["dRPhotonLepton[0]", "phosel_dRLeadingHadronicPhotonLepton"         ,        [120,0,6], extraPhotonCuts%("phoMediumID && photonIsHadronicPhoton"),"", False],
                      "phosel_dRLeadingHadronicFakeLepton"         : ["dRPhotonLepton[0]", "phosel_dRLeadingHadronicFakeLepton"        ,        [120,0,6], extraPhotonCuts%("phoMediumID && photonIsHadronicFake"),"", False],
                      ...
                      "phosel_noCut_SIEIE_GenuinePhoton"      : ["loosePhoSIEIE"   , "phosel_noCut_SIEIE_GenuinePhoton"     ,     [100,0.,.07], extraPhotonCuts%("loosePhoMediumIDPassHoverE && loosePhoMediumIDPassChIso && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso && loosePhotonIsGenuine"), "", False],
                      ...
                      "phosel_noCut_SIEIE_HadronicPhoton"     : ["loosePhoSIEIE"   , "phosel_noCut_SIEIE_HadronicPhoton"         ,     [100,0.,.07], extraPhotonCuts%("loosePhoMediumIDPassHoverE && loosePhoMediumIDPassChIso && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso && loosePhotonIsHadronicPhoton"), "", False],
                      "phosel_noCut_SIEIE_HadronicFake"       : ["loosePhoSIEIE"   , "phosel_noCut_SIEIE_HadronicFake"        ,     [100,0.,.07], extraPhotonCuts%("loosePhoMediumIDPassHoverE && loosePhoMediumIDPassChIso && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso && loosePhotonIsHadronicFake"), "", False],
                      ...
                      "phosel_noCut_ChIso_barrel"             : ["loosePhoPFChIso" , "phosel_noCut_ChIso_barrel"         ,       [200,0,20], extraPhotonCuts%("abs(loosePhoSCEta)<1.47 && loosePhoMediumIDPassHoverE && loosePhoMediumIDPassSIEIE && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso"), "", True],
                      "phosel_noCut_ChIso_endcap"             : ["loosePhoPFChIso" , "phosel_noCut_ChIso_endcap"         ,       [200,0,20], extraPhotonCuts%("abs(loosePhoSCEta)>1.47 && loosePhoMediumIDPassHoverE && loosePhoMediumIDPassSIEIE && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso"), "", True],
                      ...
                      "phosel_AntiSIEIE_ChIso"                : ["loosePhoPFChIso" , "phosel_AntiSIEIE_ChIso"            ,       [200,0,20], extraPhotonCuts%("loosePhoMediumIDPassHoverE && ( (loosePhoSIEIE>0.012 && loosePhoSIEIE<0.35 && abs(loosePhoSCEta)<1.47) || (loosePhoSIEIE>0.032 && loosePhoSIEIE<0.55 && abs(loosePhoSCEta)>1.47) ) && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso")                               , "", True],
                      "phosel_AntiSIEIE_ChIso_GenuinePhoton"  : ["loosePhoPFChIso" , "phosel_AntiSIEIE_ChIso_GenuinePhoton" ,       [200,0,20], extraPhotonCuts%("loosePhoMediumIDPassHoverE && ( (loosePhoSIEIE>0.012 && loosePhoSIEIE<0.35 && abs(loosePhoSCEta)<1.47) || (loosePhoSIEIE>0.032 && loosePhoSIEIE<0.55 && abs(loosePhoSCEta)>1.47) ) && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso && loosePhotonIsGenuine")       , "", False],
                      "phosel_AntiSIEIE_ChIso_MisIDEle"       : ["loosePhoPFChIso" , "phosel_AntiSIEIE_ChIso_MisIDEle"   ,       [200,0,20], extraPhotonCuts%("loosePhoMediumIDPassHoverE && ( (loosePhoSIEIE>0.012 && loosePhoSIEIE<0.35 && abs(loosePhoSCEta)<1.47) || (loosePhoSIEIE>0.032 && loosePhoSIEIE<0.55 && abs(loosePhoSCEta)>1.47) ) && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso && loosePhotonIsMisIDEle")      , "", False],
                      "phosel_AntiSIEIE_ChIso_HadronicPhoton" : ["loosePhoPFChIso" , "phosel_AntiSIEIE_ChIso_HadronicPhoton",       [200,0,20], extraPhotonCuts%("loosePhoMediumIDPassHoverE && ( (loosePhoSIEIE>0.012 && loosePhoSIEIE<0.35 && abs(loosePhoSCEta)<1.47) || (loosePhoSIEIE>0.032 && loosePhoSIEIE<0.55 && abs(loosePhoSCEta)>1.47) ) && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso && loosePhotonIsHadronicPhoton"), "", False],
                      "phosel_AntiSIEIE_ChIso_HadronicFake"   : ["loosePhoPFChIso" , "phosel_AntiSIEIE_ChIso_HadronicFake"    ,       [200,0,20], extraPhotonCuts%("loosePhoMediumIDPassHoverE && ( (loosePhoSIEIE>0.012 && loosePhoSIEIE<0.35 && abs(loosePhoSCEta)<1.47) || (loosePhoSIEIE>0.032 && loosePhoSIEIE<0.55 && abs(loosePhoSCEta)>1.47) ) && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso && loosePhotonIsHadronicFake")  , "", False],
                      "phosel_AntiSIEIE_ChIso_barrel"         : ["loosePhoPFChIso" , "phosel_AntiSIEIE_ChIso_barrel"    ,       [200,0,20], extraPhotonCuts%("loosePhoMediumIDPassHoverE && (loosePhoSIEIE>0.012 && loosePhoSIEIE<0.35) && (abs(loosePhoSCEta)<1.47) && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso")  , "", True],
                      "phosel_AntiSIEIE_ChIso_endcap"         : ["loosePhoPFChIso" , "phosel_AntiSIEIE_ChIso_endcap"    ,       [200,0,20], extraPhotonCuts%("loosePhoMediumIDPassHoverE && (loosePhoSIEIE>0.032 && loosePhoSIEIE<0.55) && (abs(loosePhoSCEta)>1.47) && loosePhoMediumIDPassNeuIso && loosePhoMediumIDPassPhoIso")  , "", True],
       ...
       #               "phosel_RandomCone"                     : ["phoPFRandConeChIso", "phosel_RandomCone"        ,       [200,0,20], extraPhotonCuts%("phoMediumID")                           , "", False],
        #              "phosel_RandomConeJetDR"                : ["phoPFRandConeJetDR", "phosel_RandomConeJetDR"   ,        [200,0,5], extraPhotonCuts%("phoMediumID")                           , "", False],
                      "phosel_mcMomPIDGenuinePhoton"             : ["photonParentPID"   , "phosel_mcMomPIDGenuinePhoton",[2000,-1000,1000], extraPhotonCuts%("phoMediumID && photonIsGenuine")        , "", False],
         #             "phosel_mcMomPIDMisIDEle"               : ["photonParentPID"   , "phosel_mcMomPIDMisIDEle"  ,[2000,-1000,1000], extraPhotonCuts%("phoMediumID && photonIsMisIDEle")       , "", False],
          #            "phosel_mcMomPIDHadronicPhoton"                 : ["photonParentPID"   , "phosel_mcMomPIDHadronicPhoton"    ,[2000,-1000,1000], extraPhotonCuts%("phoMediumID && photonIsHadronicPhoton") , "", False],
           #           "phosel_mcMomPIDHadronicFake"                : ["photonParentPID"   , "phosel_mcMomPIDHadronicFake"   ,[2000,-1000,1000], extraPhotonCuts%("phoMediumID && photonIsHadronicFake")   , "", False],
