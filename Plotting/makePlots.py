...
phoselhistograms = {"photonEt"                : ["Photon Et (GeV)"            , "Events", 5, [-1,-1], regionText,  NoLog],     
                    ...
                    "AntiSIEIE_ChIso"         : ["Charged Hadron Iso (GeV)"   , "Events", 1, [-1,-1], regionText,  NoLog],
